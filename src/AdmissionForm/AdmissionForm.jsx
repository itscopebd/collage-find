...
const AdmissionForm = () => {
    ...
    const onSubmit = data => {
        ...
        fetch(image_host_url, {
            ...
            .then(ImageHostRes => {
                ...
                const saveInfo = { name: data.name, subject: data.subject, email: data.email, number: data.number, birth: data.birth, image: imageUrl, address: data.address };
    ...
    return (
        <div class="block w-6/12 mx-auto rounded-lg bg-white p-6 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">

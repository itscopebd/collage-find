                            ...
                            <form>
                                ...
                                <div className="text-center lg:text-left flex gap-3">
                                    ...
                                    <p className="mb-0 mt-2 pt-1 text-sm font-semibold">
                                        ...
                                        <a href="#!" className="text-danger  text-red-500 transition duration-150 ease-in-out hover:text-danger-600 focus:text-danger-600 active:text-danger-700"> Login</a>
                                    </p>
                                </div>
                            </form>
